...
public class afficherClient extends JPanel {	
	...
	public afficherClient(Hotel h) {
        ...
        pIdCl.setBackground(Color.LIGHT_GRAY);
        ...
        pNomCl.setBackground(Color.LIGHT_GRAY);
        ...
        pPrenomCl.setBackground(Color.LIGHT_GRAY);
        ...
        pEmailCl.setBackground(Color.LIGHT_GRAY);
        ...
        pNumTelCl.setBackground(Color.LIGHT_GRAY);
