...
public class afficherConsommation extends JPanel{
	...
	public afficherConsommation(Hotel h) {
        ...
        pIdConso.setBackground(Color.LIGHT_GRAY);
        ...
        pSejour.setBackground(Color.LIGHT_GRAY);
        ...
        pProdMB.setBackground(Color.LIGHT_GRAY);
        ...
        pQuantite.setBackground(Color.LIGHT_GRAY);
