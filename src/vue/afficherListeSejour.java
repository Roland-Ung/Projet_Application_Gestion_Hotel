...
public class afficherListeSejour extends JPanel {
	...
	public afficherListeSejour(Hotel h) {
        ...
        setBackground(Color.LIGHT_GRAY); // couleur gris
        ...
        JComboBox<Sejour>listeSejMod = new JComboBox<>(); // liste pour modifier
        for (Client c : hotel.ListClient) {
        	for (Reservation r : c.ListReservation) {
        		listeSejMod.addItem(r.sejour);
        	}
        }
        
        JButton btnModifier = new JButton("Modifier");
        btnModifier.setBackground(Color.GRAY); // couleur gris
        
        champsPanel.add(listeSejMod);
        champsPanel.add(btnModifier);
        add(champsPanel, BorderLayout.SOUTH);
        
        boutonSupModSejour btnSupModSej = new boutonSupModSejour(hotel, listeSejMod);
        btnModifier.addActionListener(btnSupModSej);
	}
}
