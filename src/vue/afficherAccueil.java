...
public class afficherAccueil extends JPanel {
	public afficherAccueil() {
        setLayout(new BoxLayout(this, BoxLayout.Y_AXIS)); // de haut en bas
        ...
        try {
            ...
            Image imageRedim = icone.getImage().getScaledInstance(400, 400, Image.SCALE_SMOOTH); // Scale_smooth donne un meilleur rendu visuel
